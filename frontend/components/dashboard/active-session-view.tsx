...
import { Loader2, Play, ChevronDown, ChevronRight, Hash, ShieldAlert, RefreshCcw, Clock, User, AlertCircle } from 'lucide-react'
...
export function ActiveSessionView({ sessions, isLoading, onRefresh }: ActiveSessionViewProps) {
            ...
            <Card className="border-2 border-primary/20 shadow-2xl">
                <CardContent className="py-24 flex flex-col items-center justify-center space-y-4">
                    ...
                    <p className="text-sm font-semibold text-muted-foreground animate-pulse">
                        Descargando datos de sesiones activas desde Odoo...
                    </p>
                </CardContent>
            </Card>
        )
                ...
                <CardContent className="py-16 flex flex-col items-center justify-center text-center max-w-xl mx-auto space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground font-medium leading-relaxed">
                            No se encontraron sesiones abiertas en Odoo para el día actual. Esto significa que todas las cajas del punto de venta están debidamente cerradas y guardadas.
                        </p>
                    </div>
                    <Button 
                        onClick={onRefresh} 
